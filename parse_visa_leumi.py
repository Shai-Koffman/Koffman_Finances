        ...
        categorizations = [
            ...
            (Categories.RESTOURANTS_AND_HOTELS,
             ["הניל'גנא", "איצרג", "המלא", "דלישטור", "הדלוג", "והיתתמ", "היישוסה", "יצימ", "הנינמחל", "טרוגוי",
              ...
              "יאתבש", "דליוו רקסוא", "המרוג הפק", "אמרכ", "הרגלא", "הדוינחמ"]),
            ...
            (Categories.HEALTH_AND_MACABI, ["יבכמ", "ינאה עיבר רד", "הילצרה םראפ-רפוס", "הידפוטרופס", "הרואל 'רד", "םראפרפוס"]),
            (Categories.SCHOOLS, ["ךוניח", "ןיטילש ןג", "ןורהצ- םודיקל הרבחה", "asa"]),
            ...
            (Categories.CLOTHING,
             ["וגנמ", "והוס", "זיירוססקא", "FLOG", "ורטסק", "סדיק-יימ", "ילענ", "סידוה", "לטילא", "הלדיימ", "יול תירש",
              ...
              "ירצומ-יקונית", "רב דנא לופ","ןונמת", "ינועבצ" ]),
