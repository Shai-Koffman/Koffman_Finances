...
Categorizations = [
            ...
            (Categories.RESTAURANTS_AND_HOTELS,['אונזה','קופי פלאנט','CAROLINA','ריבאר','NAI  LON','דיינר מקום של בשר','קליאופטרה','NONO','אר קפה','אדום בר בע"מ','מקדונלדס','אונמי','שירותי בר בארועים', 'פורטונה פיצה', 'ארקפה ', 'פיצה ביס', 'נונומימי'
            ...
            (Categories.OTHER_FOOD,['פיצה פאי','בנדיקט','זורנו','רולדין','דרך היין בעמ','תותי משק טל','התות של עבודי','ליל סיס','ממלכת הקלייה - LENNY','מאפיית טלר','פרינה','משק רבינוביץ','ודיע מאנה בע"מ','ירק השדה - שטח-צמרת','אמיגו קפה','בוטיק סנטרל כפר סבא','שוק','התמרים','יובל','ROLADIN', 'מרכז הזמנו', 'סוליקה', 'WOLT', 'בוטיק סטנרל', 'בבקה ', 'עולם הממתקים', 'מאפית טלר'
            ...
            (Categories.INTERNET_AND_PHONES, ['DISNEY','טלזר 019 שירותי תקשו','SIMTLV - כרטיסי סים','HOT', 'SPIGEN', 'פרטנר', 'סלקום ', 'פלאפון']),
            (Categories.INVESTMENTS, ['מנורה מבטחים-חיים/בריאות']),
            (Categories.ELECTRICITY, ["חשמל"]),
            (Categories.MISC, ['יד 2','מוזלים','שמיע','יד שרה','הום סנטר','כהן יצחק','ההחברה לאמנות ולתרבו','דמי כרטיס הנחה','ר.האוכלוסין וההגירה-','החברה לקידום החינוך והתרב','פרומרקטינג וויזרד','רעננה  BTW','2017','מגדל לוינשטיין בע"מ','חלאתי בע"מ','ברגע האחרון' ,'וולקום טכנולוגיות בעמ','פאנקי ', 'לוקר אמבין ', "יהושע בפארק ", 'קורט צבי הולנדר ', 'צורי ובניו', 'קפלה'
            ...
            (Categories.CAR_EXPENSES, ['העברת בעלות','אחוזת החוף חברה חדשה','מנהרות הכרמל','דניאל פרקינג','אחוזת החוף מפעל הפיס','חניונים', 'חניה', 'רכבת', 'טעינת', 'פנגו', 'חניון', 'GETT', 'איתוראן', 'חניו', 'כביש 6', 'קאר', 'חניוני', 'הרכב','אי.וי.']),
            ...
            (Categories.HUGIM, ['קאנטרי','לנוער', 'מחול', 'אולדרימס', 'שבט איתן', ' ספורט ', 'אנרגים', 'סטודיו']),
            
            (Categories.CASPOMAT, ["כספומט"]),
           
            (Categories.CLOTHING,['תמנון','אליטל','נעלי','מגדלור','שלי זאנטקרן','את לבני נשים חנות אי','טופ טן','ליאת ומירב כ"ס','DREAM SPORT מתחם  -G','נייקי ישראל - סניף ח','H&M','מרגלית ילדים', 'דרים ספורט', 'קרולינה למקה ', 'S WEAR', 'דלתא', 'רנואר', 'WE SHOSE',
            ...
            (Categories.FUN_AND_MOVIES, ['ספלאש',"גיל גורג'",'קופת תל אביב','בארבי','סינמה','סינמה סיטי-קופות','זאפה','מקס ', 'ארץ ערבה', 'סטימצקי', 'קופת כרטיסים', ' סינמה' , ' צלילה', ' פינוקים ', 'מוזיאון ישראל', 'היכל התרבות', 'PUZZLEBOX', 'מלון השרון']),
            (Categories.ABROAD_EXPENSES,  ['FIRENZE','SECOURS','AGS AIRGATE SHOP','GENEVE','CENTRE','PHARMACIE','SETAM','SHERPA','CARREF.MONTAGNE','SEVABEL','DUBAI','AUTOGRILL','ADDIS','STORE','SPORT & MODE ZANGERL','שקם דיוטי','AIRBNB', 'HERCULES GREEK', 'SEA LIFE', 'TIN BUILDING', 'HULK CART', 
