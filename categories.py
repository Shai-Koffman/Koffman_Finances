...
Categorizations = [
            ...
            (Categories.RESTAURANTS_AND_HOTELS,['פרינה','ריבאר','NAI  LON','דיינר מקום של בשר','קליאופטרה','NONO','אר קפה','אדום בר בע"מ','מקדונלדס','אונמי','שירותי בר בארועים', 'פורטונה פיצה', 'ארקפה ', 'פיצה ביס', 'נונומימי'
            ...
            (Categories.OTHER_FOOD,['ודיע מאנה בע"מ','ירק השדה - שטח-צמרת','אמיגו קפה','בוטיק סנטרל כפר סבא','שוק','התמרים','יובל','ROLADIN', 'מרכז הזמנו', 'סוליקה', 'WOLT', 'בוטיק סטנרל', 'בבקה ', 'עולם הממתקים', 'מאפית טלר'
            ...
            (Categories.INTERNET_AND_PHONES, ['SIMTLV - כרטיסי סים','HOT', 'SPIGEN', 'פרטנר', 'סלקום ', 'פלאפון']),
            (Categories.INVESTMENTS, ['מנורה מבטחים-חיים/בריאות']),
            (Categories.ELECTRICITY, ["חשמל"]),
            (Categories.MISC, ['החברה לקידום החינוך והתרב','פרומרקטינג וויזרד','רעננה  BTW','2017','מגדל לוינשטיין בע"מ','חלאתי בע"מ','ברגע האחרון' ,'וולקום טכנולוגיות בעמ','פאנקי ', 'לוקר אמבין ', "יהושע בפארק ", 'קורט צבי הולנדר ', 'צורי ובניו', 'קפלה'
            ...
            (Categories.CAR_EXPENSES, ['מנהרות הכרמל','דניאל פרקינג','אחוזת החוף מפעל הפיס','חניונים', 'חניה', 'רכבת', 'טעינת', 'פנגו', 'חניון', 'GETT', 'איתוראן', 'חניו', 'כביש 6', 'קאר', 'חניוני', 'הרכב','אי.וי.']),
            ...
            (Categories.HEALTH_AND_MACABI, ['IHERB','נקודה בלב נתלי אלקובי','אופטיקה פרקש','מכבידנט', 'מכבי', 'רפואי', 'דראגסטורס', 'מדיקל', 'סופר פארם','רביע','סופר-פארם','פנופארם']),
